...
<head>
	...
	<link rel="stylesheet" href="{{asset('css/client/flaticon.css')}}"/>
	<link rel="stylesheet" href="{{asset('css/client/slicknav.min.css')}}"/>
	...
	<link rel="stylesheet" href="{{asset('css/client/angular-material.css')}}"/>
...
@endif
@if(session()->has('require_login') && session()->get('require_login'))
	<div ng-init="showForm($event,'login')"></div>
@endif
	<!-- Page Preloder -->
	<div id="preloder">
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-xl-4 col-lg-5">
						<div class="user-panel" style="float: left">
							<span class="up-item">
								<i class="flaticon-profile"></i>
								@if (Auth()->check())
								<ul class="main-menu" style="clear: left;float: right">
								<li><a style="tex">&ensp;{{Auth()->user()->name}}</a>
									<ul class="sub-menu">
								...
								<ul class="main-menu" style="clear: left;float: right">
								<li>
									<a>&ensp;(Admin)&ensp;{{Auth()->guard('admins')->user()->name}}</a>
									<ul class="sub-menu">
								...
								@else
								<span class="btn" ng-click="showForm($event,'login')">Sign In</span> <span class="btn" ng-click="showForm($event,'register')">Create Account</span>
								@endif
							</div>
							<div class="up-item">
