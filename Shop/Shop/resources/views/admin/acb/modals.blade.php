                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Modals</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
            ...
            <div class="container-fluid">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <div class="modal-bootstrap mg-tb-30">
                            ...
                            <div class="modal-area-button">
                                ...
                                <a class="Information Information-color mg-b-10" href="#" data-toggle="modal" data-target="#InformationproModalalert">Information</a>
                                ...
                                <a class="Alert Alert-color" href="#" data-toggle="modal" data-target="#AlertModalalert">Alert</a>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <div class="modal-bootstrap mg-tb-30">
                            ...
                            <div class="modal-area-button">
                                ...
                                <a class="Information Information-color mg-b-10" href="#" data-toggle="modal" data-target="#InformationproModalftblack">Information</a>
                                <a class="Warning Warning-color mg-b-10" href="#" data-toggle="modal" data-target="#WarningModalftblack">Warning</a>
                                <a class="Danger danger-color" href="#" data-toggle="modal" data-target="#DangerModalftblack">Danger</a>
                                <a class="Alert Alert-color" href="#" data-toggle="modal" data-target="#AlertModalftblack">Alert</a>
                            </div>
                        </div>
                        ...
                        <div id="WarningModalftblack" class="modal modal-adminpro-general Customwidth-popup-WarningModal PrimaryModal-bgcolor fade" role="dialog">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-close-area modal-close-df">
                                        <a class="close" data-dismiss="modal" href="#"><i class="fa fa-close"></i></a>
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        ...
                        <div id="InformationproModalhdbgcl" class="modal modal-adminpro-general fullwidth-popup-InformationproModal fade" role="dialog">
                            <div class="modal-dialog">
                                <div class="modal-content">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <div class="modal-bootstrap res-mg-t-30">
                            <h2>Black Background Modal</h2>
                            <p>Bootstrap provides an easy way to create predefined alert messages. They support a number of use cases from user notification to completely custom content and feature a handful of helpful subcomponents, sizes, and more.</p>
                            <div class="modal-area-button">
                                <a class="Primary mg-b-10" href="#" data-toggle="modal" data-target="#PrimaryModalblbgpro">Primary</a>
                                <a class="Information Information-color mg-b-10" href="#" data-toggle="modal" data-target="#InformationproModalblbgpro">Information</a>
                                <a class="Warning Warning-color mg-b-10" href="#" data-toggle="modal" data-target="#WarningModalblbgpro">Warning</a>
                                <a class="Danger danger-color" href="#" data-toggle="modal" data-target="#DangerModalblbgpro">Danger</a>
                                <a class="Alert Alert-color" href="#" data-toggle="modal" data-target="#AlertModalblbgpro">Alert</a>
                            </div>
                        </div>
                        ...
                        <div id="AlertModalblbgpro" class="modal modal-adminpro-general FullColor-popup-AlertModal PrimaryModal-bgcolor fade" role="dialog">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-close-area modal-close-df">
                                        <a class="close" data-dismiss="modal" href="#"><i class="fa fa-close"></i></a>
