...
<body>
    ...
    <div class="all-content-wrapper">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Peity</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
        ...
        <!-- Small chart Start-->
        <div class="sparkline-area mg-t-15">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <div class="about-sparkline responsive-mg-b-30">
                            ...
                            <div class="sparkline-content">
                                <p>Peity (sounds like deity) is a jQuery plugin that converts an element's content into a angle svg mini pie donut line or bar chart and is compatible with any browser that supports angle svg: Chrome, Firefox, IE9+, Opera,
                                    Safari.</p>
                                <p>Passing a radius will set the correct width and height, the pie will always be a circle that fits the available space.</p>
                        ...
                        <div class="sparkline-list">
                            ...
                            <div class="smart-sparkline-list smart-pie-list peity-res-scroll">
                                <table class="table table-bordered table-adminpro">
                                    <thead>
                                        <tr>
                                            <th class="code-adminpro-center">Graph</th>
                                            <th>Code</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
                                            <td class="code-adminpro-center">
