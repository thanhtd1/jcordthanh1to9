                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Sparkline</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <div class="about-sparkline responsive-mg-b-30">
                            ...
                            <div class="sparkline-content">
                                ...
                                <p>The plugin is compatible with most modern browsers and has been tested with Firefox 2+, Safari 3+, Opera 9, Google Chrome and Internet Explorer 6, 7, 8, 9 & 10 as well as Android.</p>
                            ...
                            <div class="smart-sparkline-list">
                                <table class="table table-bordered table-adminpro">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <span class="sparklineadminpro"></span>
                                            </td>
                                            <td>
                                                Bar chart Positive
                                            </td>
