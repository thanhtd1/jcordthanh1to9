<div class="single-product-tab-area mg-t-0 mg-b-30" ng-app="MyApp" ng-controller="AppCtrl as ctrl">
                        ...
                        <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12">
                            <div id="myTabContent1" class="tab-content">
                                <div class="product-tab-list tab-pane fade active in" id="single-tab1">
                                    <img src="{{$product->image}}" alt="" style="width: 570px"/>
                                </div>
                                <div class="product-tab-list tab-pane fade" id="single-tab2">
                                    <img src="{{$product->image}}" alt="" style="width: 170px" />
                                </div>
                            ...
                            <ul id="single-product-tab">
                                <li class="active">
                                    <a href="#single-tab1"><img src="{{$product->image}}" alt="" style="width: 170px" /></a>
                                </li>
                                <li>
                                    <a href="#single-tab2"><img src="{{$product->image}}" alt="" style="width: 170px" /></a>
                                </li>
                                <li>
                                    <a href="#single-tab3"><img src="{{$product->image}}" alt="" style="width: 170px" /></a>
                                </li>
                                <li>
                                    <a href="#single-tab4"><img src="{{$product->image}}" alt="" style="width: 170px" /></a>
                                </li>
                            </ul>
                        </div>
                        <div class="col-lg-7 col-md-7 col-sm-7 col-xs-12">
                            <div class="single-product-details res-pro-tb">
                                    <div class="add-product">
                                        <a class="btn" ng-click="ctrl.load_content('admin/view/product-list')">Back to list</a>
                                    </div>
                                <h1>
                                    {{$product->name}}</h1>
