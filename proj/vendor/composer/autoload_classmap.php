...
return array(
    'BVUser' => $baseDir . '/lib/validate/level3/BVUser.php',
    'Cast' => $baseDir . '/lib/validate/Cast.php',
    'Colors\\Display' => $baseDir . '/tests/Excel_test/unitTestColor.php',
    'ErrorInfo' => $baseDir . '/lib/validate/ErrorInfo.php',
    'FVAlnum' => $baseDir . '/lib/validate/level2/FVAlnum.php',
    'FVAlnumsym' => $baseDir . '/lib/validate/level2/FVAlnumsym.php',
    'FVDate' => $baseDir . '/lib/validate/level2/FVDate.php',
    'FVDefault' => $baseDir . '/lib/validate/level2/FVDefault.php',
    'FVEmail' => $baseDir . '/lib/validate/level2/FVEmail.php',
    'FVInteger' => $baseDir . '/lib/validate/level2/FVInteger.php',
    'FVString' => $baseDir . '/lib/validate/level2/FVString.php',
    'FVTelnum' => $baseDir . '/lib/validate/level2/FVTelnum.php',
    'FVZipcode' => $baseDir . '/lib/validate/level2/FVZipcode.php',
    'GetData' => $baseDir . '/tests/getData.php',
    ...
    'PVType' => $baseDir . '/lib/validate/level1/PVType.php',
    ...
    'Reason' => $baseDir . '/lib/validate/Reason.php',
    ...
    'Valid' => $baseDir . '/lib/validate/Valid.php',
    'apdCord' => $baseDir . '/lib/data/apdata/apdCord.php',
    'apdUser' => $baseDir . '/lib/data/apdata/apdUser.php',
    'apiCord' => $baseDir . '/lib/webapi/apiCord.php',
    'apiCore' => $baseDir . '/lib/webapi/apiCore.php',
    'apiUser' => $baseDir . '/lib/webapi/apiUser.php',
    'apiUserWeb' => $baseDir . '/lib/webapi/apiUserWeb.php',
    'dbdBank' => $baseDir . '/lib/data/dbdata/dbdBank.php',
    'dbdCord' => $baseDir . '/lib/data/dbdata/dbdCord.php',
    'dbdCord_bak' => $baseDir . '/lib/data/dbdata/dbdCord_bak.php',
    'dbdCord_user' => $baseDir . '/lib/data/dbdata/dbdCord_user.php',
    'dbdCore' => $baseDir . '/lib/data/dbdata/dbdCore.php',
    'dbdHosp_address' => $baseDir . '/lib/data/dbdata/dbdHosp_address.php',
    'dbdRecip' => $baseDir . '/lib/data/dbdata/dbdRecip.php',
    'dboBank' => $baseDir . '/lib/db/dbo/dboBank.php',
    'dboCord' => $baseDir . '/lib/db/dbo/dboCord.php',
    'dboCord_bak' => $baseDir . '/lib/db/dbo/dboCord_bak.php',
    'dboCord_user' => $baseDir . '/lib/db/dbo/dboCord_user.php',
    'dboCore' => $baseDir . '/lib/db/dbo/dboCore.php',
    'dboHosp_address' => $baseDir . '/lib/db/dbo/dboHosp_address.php',
    'dboRecip' => $baseDir . '/lib/db/dbo/dboRecip.php',
    'dbsvcBank' => $baseDir . '/lib/db/dbsvc/dbsvcBank.php',
    'dbsvcCommon' => $baseDir . '/lib/db/dbsvc/dbsvcCommon.php',
    'dbsvcCord' => $baseDir . '/lib/db/dbsvc/dbsvcCord.php',
    'dbsvcCord_bak' => $baseDir . '/lib/db/dbsvc/dbsvcCord_bak.php',
    'dbsvcCord_user' => $baseDir . '/lib/db/dbsvc/dbsvcCord_user.php',
    'dbsvcCore' => $baseDir . '/lib/db/dbsvc/dbsvcCore.php',
    'dbsvcHosp_address' => $baseDir . '/lib/db/dbsvc/dbsvcHosp_address.php',
    'dbsvcRecip' => $baseDir . '/lib/db/dbsvc/dbsvcRecip.php',
    'ifCore' => $baseDir . '/lib/webapi/old/ifCore.php',
    'ifJSON' => $baseDir . '/lib/webapi/old/ifJSON.php',
    'ifcmd' => $baseDir . '/lib/webapi/old/ifcmd.php',
    'logicCord' => $baseDir . '/lib/logic/logicCord.php',
    'logicUser' => $baseDir . '/lib/logic/logicUser.php',
    'newTest' => $baseDir . '/tests/newTest.php',
    'nomalTest' => $baseDir . '/tests/normalNewTest.php',
    'vEmpty' => $baseDir . '/lib/validate/level1/vEmpty.php',
    'vUnspecified' => $baseDir . '/lib/validate/level1/vUnspecified.php',
    'validCord' => $baseDir . '/lib/validate/validCord.php',
    'validUser' => $baseDir . '/lib/validate/validUser.php',
    'webapiCMD' => $baseDir . '/lib/webapi/webapiCMD.php',
    'webapiCore' => $baseDir . '/lib/webapi/webapiCore.php',
    'webapiJSON' => $baseDir . '/lib/webapi/webapiJSON.php',
);
