...
class ComposerStaticInit5e46c4022cde4a4bc7ba91885cf1ae5f
{
    public static $files = array (
        ...
        '8fc3287d5391fadd02b46c8f3cd290bc' => __DIR__ . '/../..' . '/.config.php',
    );
    ...
    public static $classMap = array (
        'BVUser' => __DIR__ . '/../..' . '/lib/validate/level3/BVUser.php',
        'Cast' => __DIR__ . '/../..' . '/lib/validate/Cast.php',
        'Colors\\Display' => __DIR__ . '/../..' . '/tests/Excel_test/unitTestColor.php',
        'ErrorInfo' => __DIR__ . '/../..' . '/lib/validate/ErrorInfo.php',
        'FVAlnum' => __DIR__ . '/../..' . '/lib/validate/level2/FVAlnum.php',
        'FVAlnumsym' => __DIR__ . '/../..' . '/lib/validate/level2/FVAlnumsym.php',
        'FVDate' => __DIR__ . '/../..' . '/lib/validate/level2/FVDate.php',
        'FVDefault' => __DIR__ . '/../..' . '/lib/validate/level2/FVDefault.php',
        'FVEmail' => __DIR__ . '/../..' . '/lib/validate/level2/FVEmail.php',
        'FVInteger' => __DIR__ . '/../..' . '/lib/validate/level2/FVInteger.php',
        'FVString' => __DIR__ . '/../..' . '/lib/validate/level2/FVString.php',
        'FVTelnum' => __DIR__ . '/../..' . '/lib/validate/level2/FVTelnum.php',
        'FVZipcode' => __DIR__ . '/../..' . '/lib/validate/level2/FVZipcode.php',
        'GetData' => __DIR__ . '/../..' . '/tests/getData.php',
        ...
        'PVType' => __DIR__ . '/../..' . '/lib/validate/level1/PVType.php',
        ...
        'Reason' => __DIR__ . '/../..' . '/lib/validate/Reason.php',
        ...
        'Valid' => __DIR__ . '/../..' . '/lib/validate/Valid.php',
        'apdCord' => __DIR__ . '/../..' . '/lib/data/apdata/apdCord.php',
        'apdUser' => __DIR__ . '/../..' . '/lib/data/apdata/apdUser.php',
        'apiCord' => __DIR__ . '/../..' . '/lib/webapi/apiCord.php',
        'apiCore' => __DIR__ . '/../..' . '/lib/webapi/apiCore.php',
        'apiUser' => __DIR__ . '/../..' . '/lib/webapi/apiUser.php',
        'apiUserWeb' => __DIR__ . '/../..' . '/lib/webapi/apiUserWeb.php',
        'dbdBank' => __DIR__ . '/../..' . '/lib/data/dbdata/dbdBank.php',
        'dbdCord' => __DIR__ . '/../..' . '/lib/data/dbdata/dbdCord.php',
        'dbdCord_bak' => __DIR__ . '/../..' . '/lib/data/dbdata/dbdCord_bak.php',
        'dbdCord_user' => __DIR__ . '/../..' . '/lib/data/dbdata/dbdCord_user.php',
        'dbdCore' => __DIR__ . '/../..' . '/lib/data/dbdata/dbdCore.php',
        'dbdHosp_address' => __DIR__ . '/../..' . '/lib/data/dbdata/dbdHosp_address.php',
        'dbdRecip' => __DIR__ . '/../..' . '/lib/data/dbdata/dbdRecip.php',
        'dboBank' => __DIR__ . '/../..' . '/lib/db/dbo/dboBank.php',
        'dboCord' => __DIR__ . '/../..' . '/lib/db/dbo/dboCord.php',
        'dboCord_bak' => __DIR__ . '/../..' . '/lib/db/dbo/dboCord_bak.php',
        'dboCord_user' => __DIR__ . '/../..' . '/lib/db/dbo/dboCord_user.php',
        'dboCore' => __DIR__ . '/../..' . '/lib/db/dbo/dboCore.php',
        'dboHosp_address' => __DIR__ . '/../..' . '/lib/db/dbo/dboHosp_address.php',
        'dboRecip' => __DIR__ . '/../..' . '/lib/db/dbo/dboRecip.php',
        'dbsvcBank' => __DIR__ . '/../..' . '/lib/db/dbsvc/dbsvcBank.php',
        'dbsvcCommon' => __DIR__ . '/../..' . '/lib/db/dbsvc/dbsvcCommon.php',
        'dbsvcCord' => __DIR__ . '/../..' . '/lib/db/dbsvc/dbsvcCord.php',
        'dbsvcCord_bak' => __DIR__ . '/../..' . '/lib/db/dbsvc/dbsvcCord_bak.php',
        'dbsvcCord_user' => __DIR__ . '/../..' . '/lib/db/dbsvc/dbsvcCord_user.php',
        'dbsvcCore' => __DIR__ . '/../..' . '/lib/db/dbsvc/dbsvcCore.php',
        'dbsvcHosp_address' => __DIR__ . '/../..' . '/lib/db/dbsvc/dbsvcHosp_address.php',
        'dbsvcRecip' => __DIR__ . '/../..' . '/lib/db/dbsvc/dbsvcRecip.php',
        'ifCore' => __DIR__ . '/../..' . '/lib/webapi/old/ifCore.php',
        'ifJSON' => __DIR__ . '/../..' . '/lib/webapi/old/ifJSON.php',
        'ifcmd' => __DIR__ . '/../..' . '/lib/webapi/old/ifcmd.php',
        'logicCord' => __DIR__ . '/../..' . '/lib/logic/logicCord.php',
        'logicUser' => __DIR__ . '/../..' . '/lib/logic/logicUser.php',
        'newTest' => __DIR__ . '/../..' . '/tests/newTest.php',
        'nomalTest' => __DIR__ . '/../..' . '/tests/normalNewTest.php',
        'vEmpty' => __DIR__ . '/../..' . '/lib/validate/level1/vEmpty.php',
        'vUnspecified' => __DIR__ . '/../..' . '/lib/validate/level1/vUnspecified.php',
        'validCord' => __DIR__ . '/../..' . '/lib/validate/validCord.php',
        'validUser' => __DIR__ . '/../..' . '/lib/validate/validUser.php',
        'webapiCMD' => __DIR__ . '/../..' . '/lib/webapi/webapiCMD.php',
        'webapiCore' => __DIR__ . '/../..' . '/lib/webapi/webapiCore.php',
        'webapiJSON' => __DIR__ . '/../..' . '/lib/webapi/webapiJSON.php',
    );

    public static function getInitializer(ClassLoader $loader)
    {
        return \Closure::bind(function () use ($loader) {
            $loader->prefixLengthsPsr4 = ComposerStaticInit5e46c4022cde4a4bc7ba91885cf1ae5f::$prefixLengthsPsr4;
            $loader->prefixDirsPsr4 = ComposerStaticInit5e46c4022cde4a4bc7ba91885cf1ae5f::$prefixDirsPsr4;
            $loader->classMap = ComposerStaticInit5e46c4022cde4a4bc7ba91885cf1ae5f::$classMap;
