 ...
 */
var __global_app;
angular.module("nispApp").controller("Application",
		["ModelService", "DataService", "Validators", "Normalizers", "CommonModels", "LogicService", "ContentsService", "groundwork", "$timeout",'$sce',"$http",
