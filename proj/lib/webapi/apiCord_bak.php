...
require_once(APD_DIR . "apdCord_bak.php");
require_once(LOGIC_DIR . "logicCord_bak.php");

class apiCord_bak extends apiCore
{
	//======================================================
	// 処理名：	コンストラクタ
	// 処理ID：	__construct
	...
	function add($in,&$out,&$err)
	{
		...
		// APD作成
		$in_apd = new apdCord_bak();
		$out_apd = new apdCord_bak();
		// 登録データ設定
